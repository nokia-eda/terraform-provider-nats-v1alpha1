---
page_title: "nats-v1alpha1 Provider"
---

# nats-v1alpha1 Provider

This provider is used to interact with the resources provided by the **nats-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.

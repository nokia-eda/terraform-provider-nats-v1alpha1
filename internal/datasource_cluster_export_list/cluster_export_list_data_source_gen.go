								...
								"destinations": schema.ListNestedAttribute{
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"name": schema.StringAttribute{
												Optional:            true,
												Description:         "Cluster Publisher name.",
												MarkdownDescription: "Cluster Publisher name.",
											},
									...
									Optional:            true,
									Description:         "List of NATS cluster destination where metrics must be exported.",
									MarkdownDescription: "List of NATS cluster destination where metrics must be exported.",
								},
										...
										"alarms": schema.SingleNestedAttribute{
											Attributes: map[string]schema.Attribute{
												...
												"namespaces": schema.ListAttribute{
													ElementType:         types.StringType,
													Optional:            true,
													Description:         "List of namespaces to export alarms from.",
													MarkdownDescription: "List of namespaces to export alarms from.",
												},
											},

...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-nats/internal/datasource_export"
...
const read_ds_export = "/apps/nats.eda.nokia.com/v1alpha1/namespaces/{namespace}/exports/{name}"

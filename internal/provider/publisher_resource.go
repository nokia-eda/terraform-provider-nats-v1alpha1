...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-nats/internal/resource_publisher"
	"github.com/nokia/eda/apps/terraform-provider-nats/internal/tfutils"
)

const (
	create_rs_publisher = "/apps/nats.eda.nokia.com/v1alpha1/namespaces/{namespace}/publishers"
	read_rs_publisher   = "/apps/nats.eda.nokia.com/v1alpha1/namespaces/{namespace}/publishers/{name}"
	update_rs_publisher = "/apps/nats.eda.nokia.com/v1alpha1/namespaces/{namespace}/publishers/{name}"
	delete_rs_publisher = "/apps/nats.eda.nokia.com/v1alpha1/namespaces/{namespace}/publishers/{name}"
)
...
func (r *publisherResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_publisher"
}

func (r *publisherResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_publisher.PublisherResourceSchema(ctx)
}

func (r *publisherResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_publisher.PublisherModel
	...
	err = r.client.Create(ctx, create_rs_publisher, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_publisher, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_publisher,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *publisherResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_publisher, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *publisherResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_publisher, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

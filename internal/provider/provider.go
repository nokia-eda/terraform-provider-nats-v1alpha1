...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-nats/internal/eda/utils"
...
var _ provider.Provider = (*natsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &natsProvider{version: ver}
	}
}
...
func (p *natsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewClusterPublisherDataSource,
		NewClusterPublisherListDataSource,
		NewExportDataSource,
		NewExportListDataSource,
		NewPublisherDataSource,
		NewPublisherListDataSource,
